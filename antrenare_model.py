...
def train(train_loader, model, num_epochs=5, lr=1e-4):
    ...
    with open('epoch_loss.csv','w', newline='') as csvfile:
        ...
        for epoch in range(num_epochs):
            ...
            writer.writerow('Epoch:{}, Loss:{:.4f}'.format(epoch + 1, loss.item()))
...
dataset_train1 = ImageDataset(root_dir='./patches_inainte_alunecare_12x12', transform=transforms.ToTensor())
